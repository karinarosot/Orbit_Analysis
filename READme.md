...
Project Description
This project demonstrates the verification of Kepler's Third Law of Planetary Motion (T 
2
 ∝r 
3
 ) using observational data from the Solar System. By calculating the ratio of the square of the orbital period to the cube of the semi-major axis, we can confirm the constant nature of this ratio for planets orbiting the same central body.
...
Key Features
Physical Modeling: Implementation of the formula Stosunek=T 
2
 /r 
3
 .
Data Transformation: Creation of custom columns for T 
2
  and r 
3
